# -*- coding: utf-8 -*-
"""Zeroshot_WSTM_TF-IDF_Test.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1aClbNUti8iaD0IpiF4iVCZh2DElDzSFX
"""
...
common_words = pd.DataFrame(tfidf_0[0].T.todense(),
                      index=vectorizer.get_feature_names_out(),
                      columns=["TF-IDF"])
# Sort
keyword_0 = common_words.sort_values('TF-IDF', ascending=False)

# Fit the data
tfidf_1 = vectorizer.fit_transform(df_1['NN_Description'])
# Create a dataframe of TFIDF
common_words = pd.DataFrame(tfidf_1[0].T.todense(),
                      index=vectorizer.get_feature_names_out(),
                      columns=["TF-IDF"])
# Sort
keyword_1 = common_words.sort_values('TF-IDF', ascending=False)

# Fit the data
tfidf_2 = vectorizer.fit_transform(df_2['NN_Description'])
# Create a dataframe of TFIDF
common_words = pd.DataFrame(tfidf_2[0].T.todense(),
                      index=vectorizer.get_feature_names_out(),
                      columns=["TF-IDF"])
# Sort
keyword_2 = common_words.sort_values('TF-IDF', ascending=False)

# Fit the data
tfidf_3 = vectorizer.fit_transform(df_3['NN_Description'])
# Create a dataframe of TFIDF
common_words = pd.DataFrame(tfidf_3[0].T.todense(),
                      index=vectorizer.get_feature_names_out(),
                      columns=["TF-IDF"])
# Sort
keyword_3 = common_words.sort_values('TF-IDF', ascending=False)

# Fit the data
tfidf_4 = vectorizer.fit_transform(df_4['NN_Description'])
# Create a dataframe of TFIDF
common_words = pd.DataFrame(tfidf_4[0].T.todense(),
                      index=vectorizer.get_feature_names_out(),
                      columns=["TF-IDF"])
# Sort
keyword_4 = common_words.sort_values('TF-IDF', ascending=False)
