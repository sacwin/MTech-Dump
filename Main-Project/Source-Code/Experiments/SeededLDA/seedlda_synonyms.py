# -*- coding: utf-8 -*-
"""seedLDA_Synonyms.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1fJLiBkORzy4PVn7RpU0-f_hgzhUYCs5T
"""
...
candidate_labels = data['Category'].unique()
length=len(candidate_labels)
topics={}
for i in range(0,length):
  label_i = Get_Label_Synonyms(candidate_labels[i])
  print(label_i)
  for word in label_i:
    topics[word] = i
print(topics)
...
eta_label = create_eta(topics, dictionary, 5)
